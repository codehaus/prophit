 ...
 */
public class ParseAndSolveLoader implements Loader
{
	...
	public static void main(String[] args) throws Exception
	{
		if ( args.length < 1 )
		{
			System.err.println("Usage : java orbit.parsers.ParseAndSolveLoader <file> [ <depth> ]");
	...
	public ParseAndSolveLoader(Parser parser, Solver solver, File file)
	{
		this.parser = parser;
		this.solver = solver;
		this.file = file;
